...
import '../features/login/data/data_source/local/hive/sign_in_local_storage/sign_in_local_model.dart'
    as _i14;
import '../features/login/data/data_source/remote/sign_in_service.dart' as _i20;
...
import '../features/sign_up/data/repository_impl/sign_up_repository_impl/sign_up_clicked_repository_impl.dart'
    as _i18;
import '../features/sign_up/data/source/remote/sign_up_service.dart' as _i15;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i15.SignUpService>(
        () => _i16.SignUpServiceImpl(firebaseAuth: gh<_i5.FirebaseAuth>()));
    gh.factory<_i17.SignUpClickedRepository>(() =>
        _i18.SignUpClickedRepositoryImpl(
            signUpService: gh<_i15.SignUpService>()));
    gh.factory<_i19.SignUpClickedUseCase>(() => _i19.SignUpClickedUseCase(
        signUpClickedRepository: gh<_i17.SignUpClickedRepository>()));
    gh.factory<_i20.SignInService>(
        () => _i21.SignInServiceImpl(firebaseAuth: gh<_i5.FirebaseAuth>()));
    gh.factory<_i22.SignUpBloc>(() =>
        _i22.SignUpBloc(signUpClickedUseCase: gh<_i19.SignUpClickedUseCase>()));
    gh.factory<_i23.SignInClickedRepository>(() =>
        _i24.SignInClickedRepositoryImpl(
            signInService: gh<_i20.SignInService>()));
    gh.factory<_i25.SignInClickedUseCase>(() => _i25.SignInClickedUseCase(
        signInClickedRepository: gh<_i23.SignInClickedRepository>()));
    gh.factory<_i26.LoginBloc>(() =>
        _i26.LoginBloc(signInClickedUseCase: gh<_i25.SignInClickedUseCase>()));
    return this;
  }
}
