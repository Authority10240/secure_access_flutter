...
import '../features/login/data/data_source/local/hive/sign_in_local_storage/sign_in_local_model.dart'
    as _i12;
import '../features/login/data/data_source/remote/sign_in_service.dart' as _i18;
...
import '../features/sign_up/data/repository_impl/sign_up_repository_impl/sign_up_clicked_repository_impl.dart'
    as _i16;
import '../features/sign_up/data/source/remote/sign_up_service.dart' as _i13;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i13.SignUpService>(
        () => _i14.SignUpServiceImpl(firebaseAuth: gh<_i5.FirebaseAuth>()));
    gh.factory<_i15.SignUpClickedRepository>(() =>
        _i16.SignUpClickedRepositoryImpl(
            signUpService: gh<_i13.SignUpService>()));
    gh.factory<_i17.SignUpClickedUseCase>(() => _i17.SignUpClickedUseCase(
        signUpClickedRepository: gh<_i15.SignUpClickedRepository>()));
    gh.factory<_i18.SignInService>(
        () => _i19.SignInServiceImpl(firebaseAuth: gh<_i5.FirebaseAuth>()));
    gh.factory<_i20.SignUpBloc>(() =>
        _i20.SignUpBloc(signUpClickedUseCase: gh<_i17.SignUpClickedUseCase>()));
    gh.factory<_i21.SignInClickedRepository>(() =>
        _i22.SignInClickedRepositoryImpl(
            signInService: gh<_i18.SignInService>()));
    gh.factory<_i23.SignInClickedUseCase>(() => _i23.SignInClickedUseCase(
        signInClickedRepository: gh<_i21.SignInClickedRepository>()));
    gh.factory<_i24.LoginBloc>(() =>
        _i24.LoginBloc(signInClickedUseCase: gh<_i23.SignInClickedUseCase>()));
    return this;
  }
}
